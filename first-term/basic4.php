...
if(isset($_POST['submit'])){
    ...
    if (empty($sub_name)){
      ...
      echo '<script>alert("Subject is full for this class") </script>';
          ...
          $queryb = mysqli_query($con, "insert into basic4_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
          $queryc = mysqli_query($con, "insert into basic4_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
    }
