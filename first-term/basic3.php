...
if(isset($_POST['delete'])){
  ...
  $query2 = mysqli_query($con,"delete from basic3_subject_list where subject_id = '$sub_id'");
  $query3 = mysqli_query($con,"delete from basic3_subject_list where subject_id = '$sub_id'");
