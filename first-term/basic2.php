...
if(isset($_POST['delete'])){
  ...
  $query2b = mysqli_query($con,"update basic2_".$sub_id." set `first test` = '$new', `second test` ='$new', `exam` = '$new', `Total` = '$new', `grade` = '', `position` = '' ");
  $query2c = mysqli_query($con,"update basic2_".$sub_id." set `first test` = '$new', `second test` ='$new', `exam` = '$new', `Total` = '$new', `grade` = '', `position` = '' ");
