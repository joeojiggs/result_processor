...
if (isset($_POST['process'])){
        ...
        if (mysqli_num_rows($wuery) > 0){
            ...
            while ($low = mysqli_fetch_array($wuery)){
                ...
                $avg = $grand_total/$num_of_sub;
                 ...
                 $sql4 = "update students set `first_total` = '$grand_total', `firstavg` = '$avg' where Reg_Num = '$reg_no' and Class='$class_name'";
    ...
    $last_avg = "";
    $last_i;
    $sql ="select * from students where Class='$class_name' and first_total != '$olodo' order by length(total), total DESC";
