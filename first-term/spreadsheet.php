...
if (isset($_POST['process'])){
    ...
    $last_avg = "";
    $last_i;
    $sql ="select * from students where Class='$class_name' and first_total != '$olodo' order by length(first_total), total DESC";
            ...
            while($row = mysqli_fetch_array($query)) {
                ...
                if ($avg != $last_avg){
                    ...
                    if(substr($i, -1) == 1 && substr($i, -2) != 11){
                        ...
                        $sql3 = "update students set `firstgrade` = '$grade', `position` = '$position' where Class='$class_name' and Reg_Num = '$reg_no'";
