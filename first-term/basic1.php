...
if(isset($_POST['submit'])){
    ...
    if (empty($sub_name)){
      ...
      $query2=mysqli_query($con2,"insert into basic1_subject_list (subject_id, subject_name) value ('$sub_id','$sub_name')");
      $query3=mysqli_query($con3,"insert into basic1_subject_list (subject_id, subject_name) value ('$sub_id','$sub_name')");
