...
if(isset($_POST['submit'])){
    ...
    if (empty($sub_name)){
        ...
        echo '<script>alert("Subject is full for this class") </script>';
            ...
            $query = mysqli_query($con3, "insert into kg2_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
            $queryb = mysqli_query($con3, "insert into kg2_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
