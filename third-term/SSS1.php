...
if(isset($_POST['submit'])){
    ...
    if (empty($sub_name)){
      ...
      $query = mysqli_query($con3, "insert into SSS1_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
      $queryb = mysqli_query($con3, "insert into SSS1_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
      $query = mysqli_query($con3, "insert into SSS1_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
    }
