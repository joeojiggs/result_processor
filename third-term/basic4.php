...
if(isset($_POST['submit'])){
    ...
    if (empty($sub_name)){
      ...
      $query = mysqli_query($con2, "insert into basic4_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
      $query = mysqli_query($con3, "insert into basic4_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
    }
...
if(isset($_POST['delete'])){
  ...
  $query = mysqli_query($con3,"delete from basic4_subject_list where subject_id = '$sub_id'");
