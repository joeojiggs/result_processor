...
if(isset($_POST['submit'])){
    ...
    if (empty($sub_name)){
      ...
      echo '<script>alert("Subject is full for this class") </script>';
          ...
          $queryb = mysqli_query($con3, "insert into basic2_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
          $queryc = mysqli_query($con, "insert into basic2_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
    }
    if(empty($query)){
...
if(isset($_POST['delete'])){
  ...
  $query = mysqli_query($con3,"delete from basic2_subject_list where subject_id = '$sub_id'");

  $new = 0;
  $query2 = mysqli_query($con3,"update basic2_".$sub_id." set `first test` = '$new', `second test` ='$new', `exam` = '$new', `Total` = '$new', `grade` = '', `position` = '' ");
