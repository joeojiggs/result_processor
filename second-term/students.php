...
if(isset($_POST['delete'])){
    ...
    $query7b = mysqli_query($con, "delete from ".$class."_subject6 where reg_no = '$reg_number'");
    $query7c = mysqli_query($con, "delete from ".$class."_subject6 where reg_no = '$reg_number'");
