...
if(isset($_POST['delete'])){
    ...
    $query2b = mysqli_query($con, "delete from ".$class."_subject1 where reg_no = '$reg_number'");
    $query2c = mysqli_query($con, "delete from ".$class."_subject1 where reg_no = '$reg_number'");
