...
if(isset($_POST['delete'])){
    ...
    $query16b = mysqli_query($con, "delete from ".$class."_subject15 where reg_no = '$reg_number'");
    $query16c = mysqli_query($con, "delete from ".$class."_subject15 where reg_no = '$reg_number'");
