...
if(isset($_POST['delete'])){
    ...
    $query5b = mysqli_query($con, "delete from ".$class."_subject4 where reg_no = '$reg_number'");
    ...
    $query6c = mysqli_query($con, "delete from ".$class."_subject5 where reg_no = '$reg_number'");
