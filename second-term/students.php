...
if(isset($_POST['delete'])){
    ...
    $query14b = mysqli_query($con, "delete from ".$class."_subject13 where reg_no = '$reg_number'");
    $query14c = mysqli_query($con, "delete from ".$class."_subject13 where reg_no = '$reg_number'");
