...
if(isset($_POST['delete'])){
    ...
    $query4b = mysqli_query($con, "delete from ".$class."_subject3 where reg_no = '$reg_number'");
    $query4c = mysqli_query($con, "delete from ".$class."_subject3 where reg_no = '$reg_number'");
