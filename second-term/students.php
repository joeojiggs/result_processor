...
if(isset($_POST['delete'])){
    ...
    $query8b = mysqli_query($con, "delete from ".$class."_subject7 where reg_no = '$reg_number'");
    $query8c = mysqli_query($con, "delete from ".$class."_subject7 where reg_no = '$reg_number'");    
