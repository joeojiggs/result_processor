...
if(isset($_POST['delete'])){
    ...
    $query3b = mysqli_query($con, "delete from ".$class."_subject2 where reg_no = '$reg_number'");
    $query3c = mysqli_query($con, "delete from ".$class."_subject2 where reg_no = '$reg_number'");
