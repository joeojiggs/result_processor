...
if(isset($_POST['delete'])){
    ...
    $query11b = mysqli_query($con, "delete from ".$class."_subject10 where reg_no = '$reg_number'");
    $query11c = mysqli_query($con, "delete from ".$class."_subject10 where reg_no = '$reg_number'");
