...
if(isset($_POST['delete'])){
    ...
    $query9b = mysqli_query($con, "delete from ".$class."_subject8 where reg_no = '$reg_number'");
    $query9c = mysqli_query($con, "delete from ".$class."_subject8 where reg_no = '$reg_number'");
