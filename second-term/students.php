...
if(isset($_POST['delete'])){
    ...
    $query15b = mysqli_query($con, "delete from ".$class."_subject14 where reg_no = '$reg_number'");
    $query15c = mysqli_query($con, "delete from ".$class."_subject14 where reg_no = '$reg_number'");
