...
<?php
 if (isset($_POST['reg_submit'])){
    ...
    if(mysqli_num_rows($thisquery)>0){
        ...
        $query15b = mysqli_query($con, "insert into ".$class."_subject14 (reg_no) values ('$reg_number')");
        $query15c = mysqli_query($con, "insert into ".$class."_subject14 (reg_no) values ('$reg_number')");
