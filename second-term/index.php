...
<?php
 if (isset($_POST['reg_submit'])){
    ...
    if(mysqli_num_rows($thisquery)>0){
        ...
        $query4b = mysqli_query($con, "insert into ".$class."_subject3 (reg_no) values ('$reg_number')");
        $query4c = mysqli_query($con, "insert into ".$class."_subject3 (reg_no) values ('$reg_number')");
