...
<?php
 if (isset($_POST['reg_submit'])){
    ...
    if(mysqli_num_rows($thisquery)>0){
        ...
        $query11b = mysqli_query($con, "insert into ".$class."_subject10 (reg_no) values ('$reg_number')");
        $query11c = mysqli_query($con, "insert into ".$class."_subject10 (reg_no) values ('$reg_number')");
