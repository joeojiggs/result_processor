...
<?php
 if (isset($_POST['reg_submit'])){
    ...
    if(mysqli_num_rows($thisquery)>0){
        ...
        $query13b = mysqli_query($con, "insert into ".$class."_subject12 (reg_no) values ('$reg_number')");
        $query13c = mysqli_query($con, "insert into ".$class."_subject12 (reg_no) values ('$reg_number')");
