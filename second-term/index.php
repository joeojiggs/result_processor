...
<?php
 if (isset($_POST['reg_submit'])){
    ...
    if(mysqli_num_rows($thisquery)>0){
        ...
        $query8b = mysqli_query($cona, "insert into ".$class."_subject7 (reg_no) values ('$reg_number')");
        $query8c = mysqli_query($con, "insert into ".$class."_subject7 (reg_no) values ('$reg_number')");
