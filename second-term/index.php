...
<?php
 if (isset($_POST['reg_submit'])){
    ...
    if(mysqli_num_rows($thisquery)>0){
        ...
        $query9b = mysqli_query($con, "insert into ".$class."_subject8 (reg_no) values ('$reg_number')");
        $query9c = mysqli_query($con, "insert into ".$class."_subject8 (reg_no) values ('$reg_number')");
