...
<?php
 if (isset($_POST['reg_submit'])){
    ...
    if(mysqli_num_rows($thisquery)>0){
        ...
        $query3b = mysqli_query($con, "insert into ".$class."_subject2 (reg_no) values ('$reg_number')");
        $query3c = mysqli_query($con, "insert into ".$class."_subject2 (reg_no) values ('$reg_number')");
