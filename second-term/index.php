...
<?php
 if (isset($_POST['reg_submit'])){
    ...
    if(mysqli_num_rows($thisquery)>0){
        ...
        $query10b = mysqli_query($con, "insert into ".$class."_subject9 (reg_no) values ('$reg_number')");
        $query10c = mysqli_query($con, "insert into ".$class."_subject9 (reg_no) values ('$reg_number')");
