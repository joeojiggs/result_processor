...
if(isset($_POST['delete'])){
    ...
    $query = mysqli_query($con2,"delete from kg2_subject_list where subject_id = '$sub_id'");
    $queryb = mysqli_query($con2,"delete from kg2_subject_list where subject_id = '$sub_id'");
    $queryc = mysqli_query($con2,"delete from kg2_subject_list where subject_id = '$sub_id'");
