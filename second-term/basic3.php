...
if(isset($_POST['submit'])){
    ...
    if (empty($sub_name)){
      ...
      echo '<script>alert("Subject is full for this class") </script>';
          ...
          $query = mysqli_query($con2, "insert into basic3_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
          $queryb = mysqli_query($con2, "insert into basic3_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
          $queryc = mysqli_query($con2, "insert into basic3_subject_list(subject_id, subject_name) value ('$sub_id', '$sub_name')");
    }
...
if(isset($_POST['delete'])){
  ...
  $query = mysqli_query($con2,"delete from basic3_subject_list where subject_id = '$sub_id'");

  $new = 0;
  $query2 = mysqli_query($con2,"update basic3_".$sub_id." set `first test` = '$new', `second test` ='$new', `exam` = '$new', `Total` = '$new', `grade` = '', `position` = '' ");
